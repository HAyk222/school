...
echo $_SERVER['HTTP_HOST']; ?>/dist/img/noavatarn.png">
    ...
    <div class="col-md-8">
      ...
      <div class="form-group">
        <label class="control-label col-sm-2" for="position">Պաշտոն:</label>
        <div class="col-sm-10">          
...
echo $_SERVER['HTTP_HOST']; ?>/upload/">
    ...
    <div class="col-md-8">
      ...
      <div class="form-group">
        <label class="control-label col-sm-2" for="surname_edit">Ազգանուն:</label>
        <div class="col-sm-10">          
          <input type="text" class="form-control" id="surname_edit" placeholder="Enter surname" name="surname">
        </div><br /><br />
      </div>
      <div class="form-group">
        <label class="control-label col-sm-2" for="position_edit">Պաշտոն:</label>
        <div class="col-sm-10">          
      ...
      jQuery.ajax({
        ...
        success: function(result){
          ...
          setTimeout(function(){
            ...
            jQuery(el).parent().parent().find("td:nth-child(3)").text(data[0].surname);
            jQuery(el).parent().parent().find("td:nth-child(4)").text(data[0].pashton);
