...
class PersonnelAdministrativeController extends Controller
{

    public function administrative(){
        $data = DB::table('varchakazm')->get();

        $classArr = array("dashboard" => "", "personnel" => "active", "personnel_open" => "menu-open", "administrative" => "active", "educational" => "", "educational_open" => "", "teachers" => "", "other" => "", "serving" => "", "topic" => "");
    	...
    	return view("admin.personnel.administrative",["data"=>$data, "class" => $classArr, "title" => $title, "action_url" => $action_url, "data_position" => $array, "ajax_url" => $ajax_url, "update_url" => $update_url, "delete_url" => $delete_url]);
    }
